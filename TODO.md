...
- [x] **Add architecture docs** -- Full repo walkthrough with data flow diagram, layer breakdown, tradeoffs, and tech stack table (see `docs/architecture-data-flow.md`).
